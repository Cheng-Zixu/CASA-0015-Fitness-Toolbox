          ...
          Expanded(child: ListView.builder(
            itemCount: context.watch<ExerciseModel>().data.length,
              itemBuilder: (BuildContext context, int index) {
                Exercise itemDate = context.watch<ExerciseModel>().data[index];
              return Dismissible(
                  key: Key("'key${index}'"),
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('${itemDate.date},   ${itemDate.type == 1?itemDate.seconds:itemDate.calories}${itemDate.type == 1?"s":'kcal'}'),
                        Divider(thickness: 1, indent: 10, endIndent: 10,),
                      ],
                    ),
                  ),
                onDismissed: (direction) async {
                  await Provider.of<ExerciseModel>(context,listen: false).removeExercise(itemDate);
                },
              );
