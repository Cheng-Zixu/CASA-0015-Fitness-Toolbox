        ...
        children: [
          Container(
            ...
            child: _controller.value.isInitialized
              ...
              child: Text(Configs.bb, style: TextStyle(fontSize: 16, color: Colors.white),),
            ),
          ),
          SizedBox(height: 50,),
          InkWell(
          ...
          InkWell(
            onTap: () {
              Provider.of<ExerciseModel>(context,listen: false).addExercise(Provider.of<User>(context, listen: false).email, DateTime.now().toString(), "", seconds);
